...
- [x] 1.20 **QA visual del usuario — Fase 1.** Preparar y entregarle: (a) levantar
      ...
      **Supersedida por el QA de picking de la Fase 5 (tarea 5.33), aprobado por el usuario el 2026-08-28: el recorrido de picking ejercitó wave view, ventana absoluta y el resto del sistema en la misma sesión.**
...
- [x] 2.18 Suite completa verde en ambos lados + `tsc --noEmit` en 0. Conteo
      frontend `>=` baseline.
- [x] 2.19 **QA visual del usuario — Fase 2.** Entregarle: (a) levantar el stack
...
- [x] 3.16 **QA visual del usuario — Fase 3.** Entregarle: URL
...
- [x] 4.14 **QA visual del usuario — Fase 4.** Entregarle: URL
...
- [x] 5.33 **QA visual del usuario — Fase 5.** Entregarle: URL
      ...
      **APROBADO por el usuario el 2026-08-28.**
